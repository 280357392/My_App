...
package cn.itcast.mybottomnavigationbar.widget;
...
//	 1A000000
	private int indicatorColor = 0xFF279639;//选中时指示线和文字的颜色（当前绿色） #0084FF
	private int underlineColor = 0x1A000000;//应该是按下时的颜色
	private int dividerColor = 0x1A000000;

	private boolean shouldExpand = true;//宽度按权重分配
